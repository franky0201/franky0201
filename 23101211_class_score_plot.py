...
if __name__ == '__main__':
    # Load score data
    class_kr = read_data('C:/Users/Administrator/Downloads/math01_lab/data/class_score_kr.csv')
    class_en = read_data('C:/Users/Administrator/Downloads/math01_lab/data/class_score_en.csv')
